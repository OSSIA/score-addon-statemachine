...
class DropProcessInStateMachine final : public GhostIntervalDropHandler
{
  SCORE_CONCRETE("9a094988-b05f-4e10-8e0d-56e8d46e084d")

public:
  DropProcessInStateMachine();
  void init();
private:
  bool drop(
...
class DropLayerInStateMachine final : public GhostIntervalDropHandler
{
  SCORE_CONCRETE("0eb96d95-3f5f-4e7a-b806-d03d0ac88b48")

public:
  DropLayerInStateMachine();
private:
  bool drop(
      const Scenario::ScenarioPresenter&,
      QPointF pos,
